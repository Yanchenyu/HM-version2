...
<div>
    ...
    <div class="bg" :class="{isApp:!is_weixin}">
        <header>
            <img :src="basicInfoPic?basicInfoPic:'http://externalimage.qiniu.beyondh.com/62_20171106134452.jpg'" height="230" width="100%" />
...
export default {
    ...
    data(){
        return {
            basicInfoPic: storeGet("smartHotel","hotelChooseImg"),
            userInfo: {},
