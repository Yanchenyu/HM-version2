...
<div class="outer">
  <div class="bg" :class="{isWx: isWeixin}">
    <!-- 信息说明 -->
    <div class="bookInfo">
      <div class="roomdesc cus-normal cus-flexcolumn borderBot">
    ...
    <div class="orderform ">
      <group gutter="0" class="vuxoverride">
        <x-number class="cus-normal xnumber vux-override borderBot" :title="roomcounttitle" v-model="roomcount" :min="1"
                  :max="roomMax>0?roomMax:0" width="30px"></x-number>
        <x-input class="cus-normal vux-override borderBot" v-model="orderform.bookname" label-width="80px" title="预订人"
                 placeholder="填写姓名"></x-input>
        <x-input class="cus-normal vux-override borderBot" v-model="orderform.bookmobile" label-width="80px" title="手机号"
    ...
    <div class="priceDetailList" v-show="showDetails">
      ...
      <div class="thinLine" style="margin: 0 10px;height: 0.7px;background-color: #ebebeb;" v-if="discountIndex != -1"></div>
