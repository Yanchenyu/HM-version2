...
export const fetchHotelDetail = params => {
  return axios.get(`${serviceIpHotel}/Hotel/HotelRoomTypeDetail`, {
    params: params
  })
    .then(checkStatus)
    .then(response => {
 ...
 * @param {Object} params
 */
export const getScenesAndDevices = params => {
  return axios.get(`${serviceIpHotel}/Scene/ScenesAndDevicesInRoom?roomid=${params.roomId}`, {}
  )
    .then(checkStatus)
    .then(response => {
      return response
 ...
 * @param {Object} params 
 */
export const getRoomDeviceStatus = params => {
  return axios.get(`${serviceIpHotel}/DeviceStatus/DeviceInRoom?deviceId=${params.deviceId}&roomId=${params.roomId}`, {}
  )
    .then(checkStatus)
    .then(response => {
      return response
 ...
 * @param {Object} params
 */
export const changeDeviceStatusV2 = params => {
  return axios.get(`${serviceIpHotel}/Device/Command2?roomId=${params.roomId}&MemberId=${params.MemberId}&deviceId=${params.deviceId}&deviceName=${params.deviceName}&cmdId=${params.cmdId}&cmdValue=${params.cmdValue}`, {}
  )
    .then(checkStatus)
    .then(response => {
      return response
 ...
 * @param {Object} params
 */
export const setRoomSceneV2 = params => {
  return axios.get(`${serviceIpHotel}/Scene/SetScene`, {
    params: params
  })
    .then(checkStatus)
    .then(response => {
