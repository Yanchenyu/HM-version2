  ...
  <div class="detailDesc">
    ...
    <div class="cus-small">
      <div class="flexGroup" v-for="(item,idx) in roomDetailXDialogServiceData.detailServiceTag"
        ...
        <div class="flex3span name">{{item.Name}}:</div>
        <div class="flex9span content">{{allToString(item.Content)}}</div>
      </div>
    </div>

    <div class="tagExpand cus-small cus-hintColor borderBot" v-if="roomDetailXDialogServiceData.detailServiceTag.length >= 2">
