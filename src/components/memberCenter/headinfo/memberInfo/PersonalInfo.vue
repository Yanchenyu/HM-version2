  ...
  <div>
    <div class="layout_div">
      <div style="margin-top:0;">
        <group gutter="0px">
          <x-input class="cus-normal borderBot  vux-override" style="padding: 0 10px;" type="text" title='昵称'
                   :show-clear="false"
          ...
          <div class="borderBot" @touchstart="touchStart(1)" @touchend="touchEnd(1)" style="position:relative">
          ...
          <div class="borderBot" @touchstart="touchStart(2)" @touchend="touchEnd(2)" style="position:relative">
          ...
          <div class="address borderBot" @touchstart="touchStart(3)" @touchend="touchEnd(3)" style="position:relative">
